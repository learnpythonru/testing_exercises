...
def test__parse_ineco_expense__authcode_not_used():
    # arrange
    sms = SmsMessage(
...
def test__parse_ineco_expense__not_valid_without_amount_in_sms_text():
    # arrange
    sms = SmsMessage(
...
@pytest.mark.xfail(reason='bug: need to fail when excessive text present after time (hours: minutes)')
